...
<body>
  <div id="window-container">
    <div id="game-container">
        ...
        <div id="board-left" class="default-game-board-left">
        ...
        <div id="board-right" class="default-game-board-right">
            <img id="board" class="noselect default-board" data-draggable="target" src="images/trivpur2.png" alt="" />
